...
app.AddEventHandler("OnReady", function()
	CanAttachTooltips = function()
		...
		return (not InCombatLockdown() or app.Settings:GetTooltipSetting("DisplayInCombat")) and app.Settings:GetTooltipSetting("Enabled") --app.Settings:GetTooltipSettingWithMod("Enabled")
	end
end)
